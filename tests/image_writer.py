...
class TestCollator(unittest.TestCase):
    def test_get_image_name(self):
        ...
        self.assertEqual(get_image_name(path, 1, "jpg", "000.jpg"), f"{path}1.jpg")
        self.assertEqual(get_image_name(path, 2, "jpg", "000.jpg"), f"{path}02.jpg")
        self.assertEqual(get_image_name(path, 999, "jpg", None), f"{path}999.jpg")
        ...
        self.assertRaisesRegex(
            FileNotFoundError,
            "File not found\(1\.jpg or 01\.jpg or 001\.jpg\)",
            get_image_name,
            ".",
            1,
            "jpg",
        ...
        self.assertRaisesRegex(
            FileNotFoundError,
            "File not found\(11\.jpg or 011\.jpg\)",
            get_image_name,
            ".",
            11,
            "jpg",
